...
#   author:proanimer
#   createTime:2024/6/11 下午6:52
#   lastModifiedTime:2024/6/11 下午6:52
#   file:vit.py
...
class ViT(nn.Module):
    def __init__(self, *, img_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool='cls', channels=3,
                 dim_head=64,
